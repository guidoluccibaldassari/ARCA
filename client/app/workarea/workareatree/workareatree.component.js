...
var WorkareatreeComponent = /** @class */ (function () {
    function WorkareatreeComponent(workareaService, _router) {
        this.workareaService = workareaService;
        this._router = _router;
        this.tree_html = this.tree_data;
    }
    WorkareatreeComponent.prototype.ngOnInit = function () {
    ...
    //	});
    //  }
    WorkareatreeComponent.prototype.recursiveHierarchyBuilder = function (array_in, array_out, array_html_inf, array_hier_inf, id) {
    ...
    ;
    WorkareatreeComponent.prototype.treeBuilder = function (TDA, TIA, THA, IO) {
        var arrayOfText = [];
        var localOut = [];
        var localTDA = [];
        var localTIA = [];
    ...
    WorkareatreeComponent.prototype.getSideBarLinksNG = function (parent) {
        this.workareaService.getContentNG('SideBarLinksNG').subscribe(function (response) {
            ...
            for (var i = 0; i < tmp_json.length; i++) {
                ...
                if (tmp_json[i].Discende_Da == "root") { //in questo modo forzo almeno la prima ricerca per root
                    ...
                    for (var j = 0; j < tmp_outArray.length; j++) {
                        ...
                        if (tmp_json[i]._id == tmp_outArray[j]._id) {
                            already_in = 1;
                        }
                    }
    ...
    ], WorkareatreeComponent.prototype, "tree_html", void 0);
    WorkareatreeComponent = __decorate([
        core_1.Component({
            inputs: ['tree_html'],
            selector: 'workareatreeComponent',
            template: "<tree [tree_html]=\"tree_html\"></tree>"
        }),
        __metadata("design:paramtypes", [index_1.WorkareaService, router_1.Router])
    ], WorkareatreeComponent);
    return WorkareatreeComponent;
}());
exports.WorkareatreeComponent = WorkareatreeComponent;
//# sourceMappingURL=workareatree.component.js.map