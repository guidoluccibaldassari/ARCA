...
//Componente
var DetailviewerIntranetROComponent = /** @class */ (function () {
    function DetailviewerIntranetROComponent(route, detailviewerService, _environmentService, modalService
    ...
    DetailviewerIntranetROComponent.prototype.importX3d = function () {
    ...
    DetailviewerIntranetROComponent.prototype.ngOnInit = function () {
        this.localRetRows = [];
    ...
    DetailviewerIntranetROComponent.prototype.retriveDetails = function (parent, ap) {
    ...
    */
    DetailviewerIntranetROComponent.prototype.retriveChildrenData = function (parent, ap) {
    ...
    DetailviewerIntranetROComponent.prototype.retriveParentData = function (parent, ap) {
    ...
    DetailviewerIntranetROComponent.prototype.openDetailsPage = function (coll, id) {
        var ap = [];
        ap.push(coll);
        ap.push(id);
        //console.log(ap);
    ...
    DetailviewerIntranetROComponent.prototype.openModalDocument = function () {
        this.openModal('documentViewer');
    };
    DetailviewerIntranetROComponent.prototype.openModal = function (id) {
        //    this.modaldvService.open(id);
        this.modalService.open(id);
    };
    DetailviewerIntranetROComponent.prototype.closeModal = function (id) {
        //    this.modaldvService.close(id);
        this.modalService.close(id);
    };
    DetailviewerIntranetROComponent = __decorate([
        core_1.Component({
            moduleId: module.id,
            templateUrl: 'detailviewerIntranetRO.component.html'
        })
    ...
    return DetailviewerIntranetROComponent;
}());
exports.DetailviewerIntranetROComponent = DetailviewerIntranetROComponent;
//# sourceMappingURL=detailviewerIntranetRO.component.js.map