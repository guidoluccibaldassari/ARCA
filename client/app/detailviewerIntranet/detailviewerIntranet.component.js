...
//Componente
var DetailviewerIntranetComponent = /** @class */ (function () {
    function DetailviewerIntranetComponent(detailviewerService, router, route, modaldvService, _environmentService) {
        var _this = this;
    ...
    DetailviewerIntranetComponent.prototype.importX3d = function () {
    ...
    DetailviewerIntranetComponent.prototype.ngOnInit = function () {
        this.localRetRows = [];
    ...
    DetailviewerIntranetComponent.prototype.retriveDetails = function (parent, ap) {
    ...
    */
    DetailviewerIntranetComponent.prototype.retriveChildrenData = function (parent, ap) {
    ...
    DetailviewerIntranetComponent.prototype.retriveParentData = function (parent, ap) {
    ...
    DetailviewerIntranetComponent.prototype.openDetailsPage = function (coll, id) {
        var ap = [];
        ap.push(coll);
        ap.push(id);
        //console.log(ap);
    ...
    DetailviewerIntranetComponent.prototype.openModalDocument = function () {
        this.openModal('documentViewer');
    };
    DetailviewerIntranetComponent.prototype.openModal = function (id) {
        this.modaldvService.open(id);
    };
    DetailviewerIntranetComponent.prototype.closeModal = function (id) {
        this.modaldvService.close(id);
    };
    DetailviewerIntranetComponent = __decorate([
        core_1.Component({
            moduleId: module.id,
        ...
        __metadata("design:paramtypes", [index_1.DetailviewerService,
            ...
            index_2.ModaldocumentviewerService,
            index_3.EnvironmentService])
    ], DetailviewerIntranetComponent);
    return DetailviewerIntranetComponent;
}());
exports.DetailviewerIntranetComponent = DetailviewerIntranetComponent;
//# sourceMappingURL=detailviewerIntranet.component.js.map