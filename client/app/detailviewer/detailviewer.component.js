...
//Componente
var DetailviewerComponent = /** @class */ (function () {
    function DetailviewerComponent(detailviewerService, router, route, modaldvService, _environmentService) {
        var _this = this;
    ...
    DetailviewerComponent.prototype.importX3d = function () {
    ...
    DetailviewerComponent.prototype.ngOnInit = function () {
        this.localRetRows = [];
    ...
    DetailviewerComponent.prototype.retriveDetails = function (parent, ap) {
    ...
    */
    DetailviewerComponent.prototype.retriveChildrenData = function (parent, ap) {
    ...
    DetailviewerComponent.prototype.retriveParentData = function (parent, ap) {
    ...
    DetailviewerComponent.prototype.openDetailsPage = function (coll, id) {
        var ap = [];
        ap.push(coll);
        ap.push(id);
        //console.log(ap);
        this.router.navigate(['/detailviewer', ap]);
    };
    DetailviewerComponent.prototype.openModalDocument = function () {
        this.openModal('documentViewer');
    };
    DetailviewerComponent.prototype.openModal = function (id) {
        this.modaldvService.open(id);
    };
    DetailviewerComponent.prototype.closeModal = function (id) {
        this.modaldvService.close(id);
    };
    DetailviewerComponent = __decorate([
        core_1.Component({
            moduleId: module.id,
            templateUrl: 'detailviewer.component.html'
        })
    ...
    return DetailviewerComponent;
}());
exports.DetailviewerComponent = DetailviewerComponent;
//# sourceMappingURL=detailviewer.component.js.map